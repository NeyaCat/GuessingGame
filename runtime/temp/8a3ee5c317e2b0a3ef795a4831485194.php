<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\system\notice.html";i:1507648805;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\header.html";i:1506450140;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\footer.html";i:1508002063;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">  <a href="javascript:;" onclick="member_add('添加帖子','<?php echo url('system/noticeAdd'); ?>','1200','550')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加帖子</a></span>  </div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td><?php echo mb_substr(strip_tags(htmlspecialchars_decode($vo['notice_content'])),0,30); ?>...</td>
                <td><?php echo date("Y-m-d h:s:m ", $vo['create_time']); ?></td>
                <td><?php echo notice_status($vo['status']); ?></td>
                <td class="td-manage">
                    <a style="text-decoration:none" onClick="member_stop('<?php echo url('system/noticeStatus',['status'=>$vo['status']==1?0:1,'id'=>$vo['notice_id']]); ?>')" href="javascript:;"
                       title="状态"><i class="Hui-iconfont">&#xe631;</i></a>
                    <a title="编辑" href="javascript:;"
                       onclick="member_edit('编辑','<?php echo url('system/noticeEdit',['notice_id'=>$vo['notice_id']]); ?>','4','','510')"
                       class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                    <a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo url('system/noticeDel',['notice_id'=>$vo['notice_id']]); ?>','','1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
                </td>
            </tr>
