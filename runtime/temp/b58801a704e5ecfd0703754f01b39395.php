<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"E:\phpStudy\WWW\game\public/../application/admin\view\guess\audit.html";i:1508000775;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\header.html";i:1506450140;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\footer.html";i:1508002063;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">  <a href="javascript:;" onclick="member_add('添加帖子','<?php echo url('guess/betsAdd'); ?>','1200','550')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加游戏</a></span>  </div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            <thead>
            <tr class="text-c">
                <th width="70">ID</th>
                <th width="150">投注用户</th>
                <th width="200">投注赛事</th>
                <th width="50">投注金币</th>
                <th width="50">投注时间</th>
                <th width="50">投注状态</th>
                <th width="70">操作</th>
            ...
            <tr class="text-c">
                <td><?php echo $vo['bets_id']; ?></td>
                <td><?php echo $vo['user_name']; ?></td>
                <td><?php echo $vo['mname']; ?></td>
                <td><?php echo $vo['bmoney']; ?></td>
                <td><?php echo date("Y-m-d h:s:m ", $vo['create_time']); ?></td>
                <td><?php echo bets_status($vo['status']); ?></td>
                <td class="td-manage">
                    <a style="text-decoration:none" onClick="member_stop('<?php echo url('guess/betsStatus',['status'=>$vo['status']==1?0:1,'id'=>$vo['bets_id']]); ?>')" href="javascript:;"
                       title="状态"><i class="Hui-iconfont">&#xe631;</i></a>
                    <a title="编辑" href="javascript:;"
                       onclick="member_edit('编辑','<?php echo url('guess/betsEdit',['bets_id'=>$vo['bets_id']]); ?>','4','','510')"
                       class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                    <a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo url('guess/betsDel',['bets_id'=>$vo['bets_id']]); ?>','','1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
                </td>
            </tr>
