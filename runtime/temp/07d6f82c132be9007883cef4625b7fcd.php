<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"E:\phpStudy\WWW\game\public/../application/index\view\userinfo\index.html";i:1508354347;s:70:"E:\phpStudy\WWW\game\public/../application/index\view\public\main.html";i:1507386836;s:72:"E:\phpStudy\WWW\game\public/../application/index\view\public\header.html";i:1507384265;s:72:"E:\phpStudy\WWW\game\public/../application/index\view\public\footer.html";i:1507885767;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
...
<body>
    ...
    <style>
        ...
        .modal_box{    border-top: 1px solid #e5e5e5;}
        .modal_box .row{ height: 70px; line-height: 70px;}
        .modal_box .row>div{ float: left;}
        .modal_box .row .form_left{ width: 120px; text-align: right;}
        .modal_box .row .form_right{}
    </style>
    ...
    <div class="box">
        ...
        <div class="jc_history">
            <table class="table">
                ...
                <tbody>
                <?php if(is_array($betsInfo) || $betsInfo instanceof \think\Collection || $betsInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $betsInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    <td><?php echo betsStatus($vo['status']); ?></td>
        ...
        <div class="zj_history">
            <table class="table">
                ...
                <tbody>
                <?php if(is_array($costList) || $costList instanceof \think\Collection || $costList instanceof \think\Paginator): $i = 0; $__LIST__ = $costList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
...
<div class="modal fade" id="success">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <h3 style="text-align: center">申请竞猜</h3>
            </div>
            <form action="<?php echo url('Userinfo/launch'); ?>" method="post">
                <div class="modal_box">

                    <div class="row">
                        <div class="form_left">竞猜名称：</div>
                        <div class="form_right"><input value="" name="gues_name" placeholder="请填写竞猜名称" style="height: 30px; width: 300px;"/></div>
                    </div>
                    <div class="row">
                        <div class="form_left">选择比赛：</div>
                        <div class="form_right">
                            <select name="match_id"  style="height:31px;margin-left: 20px;" >
                                ...
                                <option value="<?php echo $vo['matchs_id']; ?>"><?php echo $vo['mname']; ?></option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form_left">设置赔率：</div>
                        <div class="form_right"><input value="" name="peilv" placeholder="请设置赔率" style="height: 30px; width: 300px;"/></div>
                    </div>
                    <div class="row">
                        <div class="form_left">竞猜类型：</div>
                        <div class="form_right"><input type="radio" name="guess_type" value="1" />押胜负<input type="radio" name="guess_type" value="2" />押比分</div>
                    </div>
                    <div class="row">
                        <div class="form_left">赢多少分：</div>
                        <div class="form_right"><input type="text" class="input-text" value="" placeholder="押胜负可不填，押比分必填" name="point"  style="height: 30px; width: 300px;"/></div>
                    </div>
                </div>
                <div class="modal-footer">
...
<script>
    $("#submit_btn").click(function () {
       var data={
           gues_name:$("input[name='gues_name']").val(),
           match_id:$("select[name='match_id']").val(),
           peilv:$("input[name='peilv']").val(),
           guess_type:$("input[name='guess_type']").val(),
           point:$("input[name='point']").val()
       };
       $.ajax({
           url:"<?php echo url('userinfo/launch'); ?>",
           data:data,
           type:'post',
