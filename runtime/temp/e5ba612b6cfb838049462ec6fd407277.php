<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"E:\phpStudy\WWW\game\public/../application/admin\view\guess\teamsedit.html";i:1508319281;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\header.html";i:1506450140;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\footer.html";i:1508002063;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form action="<?php echo url('guess/teamsEdit'); ?>" method="post" class="form form-horizontal" id="form-member-add">


        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>修改队伍名：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" class="input-text" value="<?php echo $oldlist['tname']; ?>" placeholder="" id="" name="tname">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">修改队伍头像：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input id="file_upload_end"  type="file" multiple="true" >
                <img style="display: block" id="upload_org_code_img_end" src="<?php echo $oldlist['timage']; ?>" width="150" height="150">
                <input id="file_upload_image_end" name="timage" type="hidden" multiple="true" value="<?php echo $oldlist['timage']; ?>">
            </div>
        </div>
        <input class="btn btn-primary radius" type="hidden" name="team_id" value="<?php echo input('param.team_id'); ?>">
        <div class="row cl">
