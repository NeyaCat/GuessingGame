<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"E:\phpStudy\WWW\game\public/../application/admin\view\guess\itemsadd.html";i:1507988531;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\header.html";i:1506450140;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\footer.html";i:1508002063;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form action="<?php echo url('guess/itemsAdd'); ?>" method="post" class="form form-horizontal" id="form-member-add">
        <br class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>投注项目名称：</label>
