<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\wamp\www\game\public/../application/admin\view\guess\teams.html";i:1507992669;s:68:"D:\wamp\www\game\public/../application/admin\view\public\header.html";i:1506450140;s:68:"D:\wamp\www\game\public/../application/admin\view\public\footer.html";i:1508002063;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td><?php echo $vo['todds']; ?></td>
                <td><?php echo $vo['gname']; ?></td>
                <td><?php echo $vo['timage']; ?></td>
                <td><?php echo date("Y-m-d h:s:m ", $vo['create_time']); ?></td>
                <td><?php echo teams_status($vo['status']); ?></td>
                <td class="td-manage">
                    <a style="text-decoration:none" onClick="member_stop('<?php echo url('guess/teamsStatus',['status'=>$vo['status']==1?0:1,'id'=>$vo['team_id']]); ?>')" href="javascript:;"
