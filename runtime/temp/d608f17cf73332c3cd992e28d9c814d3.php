<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"E:\phpStudy\WWW\game\public/../application/admin\view\guess\matchsedit.html";i:1508321775;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\header.html";i:1506450140;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\footer.html";i:1508002063;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form action="<?php echo url('guess/matchsEdit'); ?>" method="post" class="form form-horizontal" id="form-member-add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>比赛名称：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" class="input-text" value="<?php echo $oldlist['mname']; ?>" placeholder="" name="mname">
            </div>
        </div>
        <div class="row cl">
            ...
            <select name="game_id"  style="height:31px;margin-left: 20px;" >
                <option value="<?php echo $oldlist['game_id']; ?>"><?php echo getGameName($oldlist['game_id']); ?></option>
        ...
        <div class="row cl">
            ...
            <select name="team1_id"  style="height:31px;margin-left: 20px;" id="cbrand1_name" >
                <option value="<?php echo $oldlist['team1_id']; ?>"><?php echo $oldlist['team1_name']; ?></option>
            ...
            <select name="team2_id"  style="height:31px;margin-left: 20px;" id="cbrand2_name" >
                <option value="<?php echo $oldlist['team2_id']; ?>"><?php echo $oldlist['team2_name']; ?></option>
                <?php if(is_array($teamsID) || $teamsID instanceof \think\Collection || $teamsID instanceof \think\Paginator): $i = 0; $__LIST__ = $teamsID;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo $vo['team_id']; ?>"><?php echo $vo['tname']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        ...
        <div class="row cl">
            ...
            日期范围：
            <input type="text" name="starttime" class="input-text" id="" onfocus="selecttime(1)" value="<?php echo date('Y-m-d H:i:s') ###($oldlist['starttime']); ?>" style="width:120px;" >
            -
            <input type="text" name="endtime" class="input-text" id="" onfocus="selecttime(1)" value="<?php echo date('Y-m-d H:i:s') ###($oldlist['endtime']); ?>"  style="width:120px;">
        </div>

        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
                <input class="btn btn-primary radius" type="hidden" value="<?php echo $oldlist['matchs_id']; ?>" name="matchs_id">
