<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"F:\www\game\public/../application/admin\view\member\index.html";i:1507991699;s:63:"F:\www\game\public/../application/admin\view\public\header.html";i:1506450140;s:63:"F:\www\game\public/../application/admin\view\public\footer.html";i:1507465455;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td class="td-status"><?php echo gold_status($vo['gold_status']); ?></td>
                <td class="td-manage">
                    <a style="text-decoration:none" sid="<?php echo $vo['user_id']; ?>" status="<?php echo $vo['gold_status']==0?1:0; ?>" onClick="gold_statu(this,'<?php echo url('member/goldstatus'); ?>')" href="javascript:;" title="点击更改商品状态">
