<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"E:\phpStudy\WWW\game\public/../application/admin\view\messagere\index.html";i:1507467954;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\header.html";i:1506450140;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\footer.html";i:1508002063;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <form action="<?php echo url('messagere/search'); ?>" method="post">
        <div class="text-c">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">  <a href="javascript:;" onclick="member_add('添加帖子','<?php echo url('messagere/add'); ?>','1200','550')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加帖子</a></span>  </div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td><?php echo mb_substr(strip_tags(htmlspecialchars_decode($vo['messagere_content'])),0,30); ?></td>
                <td><?php echo $vo['user_name']; ?></td>
                <td><?php echo date("Y-m-d h:s:m ", $vo['create_time']); ?></td>
                <td class="td-manage">
                    <a title="编辑" href="javascript:;"
                       onclick="member_edit('编辑','<?php echo url('messagere/edit',['re_id'=>$vo['re_id']]); ?>','4','','510')"
                       class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                    <a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo url('messagere/del',['re_id'=>$vo['re_id']]); ?>','','1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
                </td>
            </tr>
