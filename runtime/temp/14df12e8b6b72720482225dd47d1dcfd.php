<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\guess\endform.html";i:1508256415;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\header.html";i:1506450140;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\footer.html";i:1508002063;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form action="" method="post" class="form form-horizontal" id="form-member-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-4">
                <?php echo $matchs['0']['mname']; ?>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">比赛开始时间：</label>
            <div class="formControls col-xs-8 col-sm-10">
                <?php echo date("Y-m-d h:s:m ", $matchs['0']['starttime']); ?>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">比赛结束时间：</label>
            <div class="formControls col-xs-8 col-sm-10">
                <?php echo date("Y-m-d h:s:m ", $matchs['0']['endtime']); ?>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">比赛队伍：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <?php echo $matchs['0']['tname1']; ?>&nbsp;&nbsp;VS&nbsp;&nbsp;<?php echo $matchs['0']['tname2']; ?>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><?php echo $matchs['0']['tname1']; ?>最终得分：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" class="input-text" value="" placeholder="" id="" name="point[0]" style="width: 120px;">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><?php echo $matchs['0']['tname2']; ?>最终得分：</label>
            <div class="formControls col-xs-8 col-sm-4">
