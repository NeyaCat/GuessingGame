<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"E:\phpStudy\WWW\game\public/../application/admin\view\guess\gamesadd.html";i:1508319960;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\header.html";i:1506450140;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\footer.html";i:1508002063;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form action="<?php echo url('guess/gamesAdd'); ?>" method="post" class="form form-horizontal" id="form-member-add">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <p><script id="editor"  type="text/plain" name="gcontent" style="width:80%;height:300px;"></script></p>
            </div>
        </div>
        <div class="row cl">
