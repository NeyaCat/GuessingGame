<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"E:\phpStudy\WWW\game\public/../application/admin\view\guess\matchs.html";i:1508255687;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\header.html";i:1506450140;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\footer.html";i:1508002063;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
            ...
            <tr class="text-c">
                ...
                <td class="td-manage">
                    ...
                    <a title="<?php echo saiShiStat($vo['status']); ?>"
                       href="<?php if($vo['status'] == 1): ?>
                            <?php echo url('guess/saiShiStatus',['id'=>$vo['matchs_id'],'sta'=>$vo['status']]); elseif($vo['status'] == 3): ?>
