<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"E:\phpStudy\WWW\game\public/../application/admin\view\guess\gamesedit.html";i:1508318181;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\header.html";i:1506450140;s:72:"E:\phpStudy\WWW\game\public/../application/admin\view\public\footer.html";i:1508002063;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form action="<?php echo url('guess/gamesEdit'); ?>" method="post" class="form form-horizontal" id="form-member-add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>游戏名称：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" class="input-text" value="<?php echo $oldlist['gname']; ?>" placeholder="" id="" name="gname">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">游戏简介：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <p><script id="editor"  type="text/plain" name="gcontent" style="width:80%;height:300px;"><?php echo $oldlist['gcontent']; ?></script></p>
            </div>
        </div>
        <input class="btn btn-primary radius" type="hidden" name="game_id" value="<?php echo input('param.game_id'); ?>">
        <div class="row cl">
